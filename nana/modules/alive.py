...
from nana import setbot, AdminSettings, BotUsername, app, COMMAND_PREFIXES, OwnerUsername
...
@app.on_message(filters.user(AdminSettings) & filters.command("alive", COMMAND_PREFIXES))
