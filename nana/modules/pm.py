...
@app.on_message(filters.me & filters.command("approve", COMMAND_PREFIXES) & filters.private)
...
@app.on_message(
    filters.me & filters.command(["revoke", "disapprove"], COMMAND_PREFIXES) & filters.private
)
